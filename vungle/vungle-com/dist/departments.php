<?php include('header.php'); //include('nav.php'); include('nav-sub.php'); ?><style>.bluemenu {background-color: #2f90ce; }</style><script>var d = document.getElementById("navigator");
	d.className = d.className + " bluemenu";</script><style>.icon-dep {
		...
		}</style><div class="container padded"><div class="page-header"><h1>What Do You Want to Do?</h1></div><ul id="departments" class="row list-inline text-center"></ul></div><script>var greenuri = 'https://api.greenhouse.io/v1/boards/vungle/embed/';
			      	...
			      	$('#departments').append(
			      		'<a href="dept.php?id='+id+'">'+
			      			'<li class="col-xs-12 col-sm-6 col-md-4 location">'+
			      				'<div class="icon-dep">'+
			      					'<img src="img/dept/'+depturl+'.jpg" onerror="this.src="/img/png/dept/'+depturl+'.png";this.onerror=null;" alt="" >'+
