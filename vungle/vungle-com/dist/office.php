<?php include('header.php'); //include('nav.php'); include('nav-sub.php'); ?><style>.bluemenu {background-color: #2f90ce; }</style><script>var d = document.getElementById("navigator");
	d.className = d.className + " bluemenu";</script><style>/*	.icon {
		...
		#bg img {
		  ...
		  min-width: 50%;
		  min-height: 50%;
		}</style><div class="hero-small padded"><div id="bg"><img id="" src="" alt=""></div><h1 id="location" class=""></h1></div><div class="container"><div class="row"><div class="col-sm-12"><h2 class="h1">Open Positions</h2><table class="table table-striped"><thead><tr><th>Position</th><th>Department</th></tr></thead><tbody id="office"></tbody></table></div></div></div><script>// Grabs query string
