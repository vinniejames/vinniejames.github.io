...
<div class="container-fluid hero-image products">
	<span class="blue-overlay"></span>	
	
	<div class="row-fluid">
		<div class="title-container wow zoomIn">
            <div class="description">
	            <h1 class="hero-heading">We are the infrastructure for in-app video advertising.</h1>
               <a href="<?=$signup?>" class="btn btn-lg btn-primary">Get Started With Our SDK</a>
            </div>
        </div><!--title-container-->
	</div>
</div>
...
<div id="highfill" class="container-fluid">
	<span class="blue-overlay half"></span>
	<div class="row background-section creative">
...
<div id="engage" class="container page-header">
        ...
        <div class="row">
	        <div class="col-sm-6 col-sm-push-6">
		        	<img class="img-responsive" src="img/product/vungle-sdk.svg">
	        </div>
	        ...
	        <ul class="dash">
		        ...
		        <li>Enjoy support for Vungle Exchange, bringing you access to high-quality brand ads</li>
		        <li>Keep your app lean with one of the lightest SDKs on the market</li>
	        </ul>
	        </div>
...
<div id="highfill" class="container-fluid">
<span class="blue-overlay"></span>
	<div class="row background-section exchange">
		...
		<div class="col-md-6 col-md-push-6">
			...
			<ul class="dash">
				...
				<li>Feel secure knowing that your ads are audible and visible on complete with Vungle’s high AVOC rating <br><br><a href="<?=$programmatic?>" class="btn btn-secondary">Learn More</a></li>
			</ul>
		</div>
...
<div id="direct" class="container page-header">
        
        <div class="row">
	        <div class="col-sm-6">
		        	<img class="img-responsive" src="img/product/vungle-direct.svg">
	        </div>
	        <div class="col-sm-6">
		        <h1>Vungle Direct</h1>
...
<div id="flexible" class="container-fluid">
	<span class="blue-overlay"></span>
	<div class="row background-section placements">
		<div class="col-xs-10 col-xs-push-1">
			<h1>Creative Ad Placements</h1>
			<p class="lead">A leader in creative placement, Vungle provides publishers with extensive flexibility. Our account managers work with the publisher to identify optimal placement in the app, and to determine the best presentation and incentive options.</p>
		</div>
	</div>
</div>
<!-- full viewheight background section-->
