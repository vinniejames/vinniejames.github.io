...
<div class="homepage-hero-module padded">
    <div class="video-container">
       ...
       <!-- Video Controls -->
        ...
        <video id="video" class="video-controls fillWidth" poster="img/about/team.jpg">
...
<div class="container people">
		...
		<div class="col-md-3 col-sm-6 wow fadeInLeft"  data-wow-delay="250ms">
			<figure>
				<div class="icons">
					 ...
					 <img class="img-responsive" src="img/careers/hustle.svg" onerror="this.src='/img/png/careers/hustle.png';this.onerror=null;" alt="">
		...
		<div class="col-md-3 col-sm-6 wow fadeInLeft">
			<figure>
				<div class="icons">
				 	...
				 	<img class="img-responsive" src="img/careers/own.svg" onerror="this.src='/img/png/careers/own.png';this.onerror=null;" alt="">
		...
		<div class="col-md-3 col-sm-6 wow fadeInRight">
			<figure>
				<div class="icons">
					...
					<img class="img-responsive" src="img/careers/transparency.svg" onerror="this.src='/img/png/careers/transparency.png';this.onerror=null;" alt="">
		...
		<div class="col-md-3 col-sm-6 wow fadeInRight" data-wow-delay="250ms">
			<figure>
				<div class="icons">
					...
					<img class="img-responsive" src="img/careers/users.svg" onerror="this.src='/img/png/careers/users.png';this.onerror=null;" alt="">
	...
	<div class="row">
		<div class="col-md-3 col-sm-6 wow fadeInLeft"  data-wow-delay="250ms">
			<figure>
				<div class="icons">
					<img class="img-responsive" src="img/careers/health.svg" onerror="this.src='/img/png/careers/health.png';this.onerror=null;" alt="">
				</div>
		...
		<div class="col-md-3 col-sm-6 wow fadeInLeft">
			<figure>
				<div class="icons">
				 	...
				 	<img class="img-responsive" src="img/careers/gym.svg" onerror="this.src='/img/png/careers/gym.png';this.onerror=null;" alt="">
		...
		<div class="col-md-3 col-sm-6 wow fadeInRight">
			<figure>
				<div class="icons">
					...
					<img class="img-responsive" src="img/careers/meals.svg" onerror="this.src='/img/png/careers/meals.png';this.onerror=null;" alt="">
		...
		<div class="col-md-3 col-sm-6 wow fadeInRight" data-wow-delay="250ms">
			<figure>
				<div class="icons">
					...
					<img class="img-responsive" src="img/careers/dog.svg" onerror="this.src='/img/png/careers/dog.png';this.onerror=null;" alt="">
...
<br>
		...
		<div class="col-md-4 col-sm-6 wow fadeInLeft"  data-wow-delay="250ms">
			<figure>
				<div class="icons">
					 ...
					 <img class="img-responsive" src="img/careers/stock-options.svg" onerror="this.src='/img/png/careers/stock-options.png';this.onerror=null;" alt="">
		...
		<div class="col-md-4 col-sm-6 wow fadeInLeft">
			<figure>
				<div class="icons">
				 	...
				 	<img class="img-responsive" src="img/careers/transport.svg" onerror="this.src='/img/png/careers/transport.png';this.onerror=null;" alt="">
		...
		<div class="col-md-4 col-sm-6 wow fadeInRight">
			<figure>
				<div class="icons">
					...
					<img class="img-responsive" src="img/careers/vungle-exchange-program.svg" onerror="this.src='/img/png/careers/vungle-exchange-program.png';this.onerror=null;" alt="">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<p class="lead">If you’re not an exact fit for one of our roles, but we like your hustle, we’ll work with you to find a home for you at Vungle. Check out our available positions <a href="<?=$departments?>">here.</a></p>
