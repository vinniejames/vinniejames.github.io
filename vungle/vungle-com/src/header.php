...
<html lang="en"><head>
  ...
  <link rel="stylesheet" href="css/background-section.css">
  ...
  <!--<link rel="stylesheet" href="css/vungle.css">-->
...
<!-- from footer at the top	-->
  <!-- Placed at the end of the document so the pages load faster -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    	<script>window.jQuery || document.write('<script src="js/jquery-1.10.2.min.js"><\/script>')</script>
    
    <!-- PROBABLY DONT NEED ANYMORE jQuery Mobile for Swipe Touch Events -->
    <script src="js/jquery.mobile.swipe.min.js"></script>
<!-- REPLACE WITH CLEAN VERSION IF ie7.js DOESNT WORK -->   
...
<!-- MUST ADD ----- AddType text/x-component .htc ----- to .htaccess -->
<!--[if lt IE 8]>
    <link rel="stylesheet" href="css/bootstrap-ie7.css" type="text/css">
<![endif]-->
